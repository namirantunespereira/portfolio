...
const I18N = {
  en: {
    ...
    hero: {
      ...
      subtitle: "I build modern, accessible, and performant applications — from polished front‑ends to scalable back‑ends and APIs.",
      ctaProjects: "View projects",
      ctaContact: "Contact me",
    },
    projects: { title: "Featured Projects", subtitle: "Selected work showcasing end‑to‑end delivery, code quality, and delightful UX." },
    ...
    about: {
      title: "About me",
      subtitle: "I’m a Full‑Stack Developer delivering robust back‑ends and refined front‑ends.",
      whoTitle: "Who I am",
      whoText: "I’m <strong>Namir Antunes</strong>, focused on building efficient, accessible, and delightful digital experiences across the stack. I value clean code, testing, performance and maintainability.",
    ...
    contact: {
      ...
      msgLabel: "Message",
      send: "Send",
      status: { fill: "Please fill in all fields.", sending: "Sending...", success: "Message sent! I’ll get back to you soon.", error: "Could not send your message. Please try again later." }
    },
  ...
  pt: {
    ...
    hero: {
      ...
      subtitle: "Construo aplicações modernas, acessíveis e performáticas — do front‑end refinado ao back‑end escalável e APIs.",
      ctaProjects: "Ver projetos",
      ctaContact: "Falar comigo",
    },
    projects: { title: "Projetos em destaque", subtitle: "Seleção que demonstra entrega ponta a ponta, qualidade de código e UX agradável." },
    actions: { demo: "Demo", code: "Código" },
    card: {
      weather: { desc: "Busca de clima por cidade ou geolocalização usando a OpenWeatherMap API." },
    ...
    about: {
      title: "Sobre mim",
      subtitle: "Sou Desenvolvedor(a) Full‑Stack, entregando back‑ends robustos e front‑ends refinados.",
      whoTitle: "Quem sou",
      whoText: "Sou <strong>Namir Antunes</strong>, focado(a) em experiências digitais eficientes, acessíveis e agradáveis em toda a stack. Valorizo código limpo, testes, performance e manutenibilidade.",
      skillsTitle: "Competências",
      skillAcc: "Acessibilidade / Performance / SEO básico",
    },
    contact: {
      title: "Contato",
      subtitle: "Vamos conversar? Preencha o formulário ou me chame no LinkedIn/GitHub.",
      nameLabel: "Nome",
      emailLabel: "E‑mail",
      msgLabel: "Mensagem",
      send: "Enviar",
      status: { fill: "Por favor, preencha todos os campos.", sending: "Enviando...", success: "Mensagem enviada! Vou te responder em breve.", error: "Não foi possível enviar sua mensagem. Tente novamente mais tarde." }
    },
...
function applyTranslations() {
  ...
  document.querySelectorAll('[data-i18n]').forEach(el => {
    ...
    let val = dict; for (const key of path) val = val?.[key];
    if (typeof val === 'string') el.innerHTML = val;
  });
  document.documentElement.lang = currentLang;
  document.getElementById('lang-en').classList.toggle('active', currentLang==='en');
  document.getElementById('lang-pt').classList.toggle('active', currentLang==='pt');
  // Append ?lang to demo links
  document.querySelectorAll('.demo-link').forEach(a => {
    const href = a.getAttribute('href');
    try { const url = new URL(href, location.origin); url.searchParams.set('lang', currentLang); a.setAttribute('href', url.pathname + url.search); } catch {}
  });
}

document.getElementById('lang-en').addEventListener('click', () => { currentLang='en'; applyTranslations(); history.replaceState({}, '', updateQuery('lang','en')); });
document.getElementById('lang-pt').addEventListener('click', () => { currentLang='pt'; applyTranslations(); history.replaceState({}, '', updateQuery('lang','pt')); });
...
form.addEventListener('submit', async (event) => {
  ...
  if (!data.name || !data.email || !data.message) { status.textContent = dict.fill; return; }
